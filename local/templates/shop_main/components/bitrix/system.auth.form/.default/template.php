            ...
            <div class="login-form"><!--login form-->
                ...
                <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top">
                    ...
                    <input placeholder="<?= GetMessage("AUTH_PASSWORD") ?>" type="password" name="USER_PASSWORD"
                           maxlength="255" size="17" autocomplete="off"/>
                    <? if ($arResult["STORE_PASSWORD"] == "Y"): ?>
                    <span>
                        <input type="checkbox" id="USER_REMEMBER_frm" name="USER_REMEMBER"
                               value="Y"><?= GetMessage("AUTH_REMEMBER_ME") ?>
                        <? endif ?>
                    <button type="submit" name="Login" value="<?= GetMessage("AUTH_LOGIN_BUTTON") ?>"
                            class="btn btn-default"><?= GetMessage("AUTH_LOGIN_BUTTON") ?></button>
                </form>
