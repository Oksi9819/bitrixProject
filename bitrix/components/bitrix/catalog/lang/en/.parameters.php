...
$MESS["COMPATIBLE_MODE_TIP"] = "Use this option for customized catalog created for iblock versions prior to 17.0.0. To improve performance, update the catalog of simple components that are used inside the composite component.";
...
$MESS["CP_BC_DETAIL_SET_VIEWED_IN_COMPONENT"] = "Keep product views data on product details page for legacy catalog";
...
$MESS["PAGER_TEMPLATE_TIP"] = "Name of a breadcrumb navigation template. If empty, the default template (<i>our_catalog</i>) will be used. Alternatively, you can use the <i>orange</i> template.";
