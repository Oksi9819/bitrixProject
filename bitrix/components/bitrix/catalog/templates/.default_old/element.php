...
if ($ElementID > 0)
{
	...
	{
		?><?$APPLICATION->IncludeComponent("bitrix:catalog.store.amount", "our_catalog", array(
	...
	{
		?><?$APPLICATION->IncludeComponent("bitrix:sale.recommended.products", "our_catalog", array(
			"ID" => $ElementID,
			"TEMPLATE_THEME" => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
